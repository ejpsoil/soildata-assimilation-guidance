...
| --- | --- | --- |
| [Code list as iso19135](cookbook/codelist-iso19135.qmd) | | Publish an XML file on a web location |
...
| Cookbook | Software | Description |
| --- | --- | --- |
| [Code list in Re3gistry](cookbook/re3gistry.qmd) | [Re3gistry](https://ec.europa.eu/isa2/solutions/re3gistry_en/) | Publish a codelist in Re3gistry |
...
| Cookbook | Software | Description |
| --- | --- | --- |
| [Extend a codelist](cookbook/code-listsExtension.qmd) |  | How to extend an INSPIRE codelist |
| [Publish a SKOS codelist](cookbook/virtuoso.qmd) | [Virtuoso](https://virtuoso.openlinksw.com/) [Skosmos](https://skosmos.org) | Publish a code list in semantic web |
| [GRLC.io](cookbook/GRLC.qmd) | [GRLC.io](https://grlc.io) | A conveniance API on top of your SPARQL endpoint |