...
```
> **Info:** All available images of deegree version 3.5.x are built with Apache Tomcat 9.x and OpenJDK 11. Check https://hub.docker.com/r/deegree/deegree3-docker for details and other deegree versions available.
