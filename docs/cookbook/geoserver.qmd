---
title: Appschema WFS in GeoServer
...
GeoServer also provides options to publish view services (WMS or WMTS). Read more about this topic in the recipe [GeoCat Bridge and GeoServer](bridge-geoserver-geonetwork.qmd).
