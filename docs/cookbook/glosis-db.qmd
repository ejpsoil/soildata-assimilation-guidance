---
title: INSPIRE Soil in a relational database
---
...
In february 2024 the EJPSoil project has published a [gpkg template](https://github.com/ejpsoil/inspire_soil_gpkg_template) based on the INSPIRE Soil data model. This template has been added to the [list of gpkg implementations](https://github.com/INSPIRE-MIF/gp-geopackage-encodings/blob/main/examples/overview.md) of INSPIRE helpdesk.
...
- Users populate the database from various sources using their favourite tool ([r](../utils/r.qmd), [python](../utils/python.qmd), [FME](https://www.safe.com/fme/fme-desktop/), [Hale studio](./hale-studio.qmd), [DBeaver](https://dbeaver.io/))
- Users publish the database as an [Atom service](./webdav.qmd) or [OGC API Features](./pygeoapi.qmd).
