...
The sensorthings api data manager configuration panel has a dedicated section, which facilitates to enrich a set of locations or features of interest with observations at those locations. Which you then can use to filter
or colorize on the map view.
