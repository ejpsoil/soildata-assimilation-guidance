...
Because docker runs locally, you need to set up a tunnel for the validator to access the local service. Read the [tunnel recipe](../utils/localtunnel.qmd) to see how to do that.
