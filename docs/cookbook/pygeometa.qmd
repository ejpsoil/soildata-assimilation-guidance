...
[Model Driven Metadata Editor](https://osgeo.github.io/mdme) (MDME) is an online visual editor for mcf files. You can create or load an existing mcf file, populate relevant fields and save or export it in various metadata formats. 

The software presents a form configurable via json-schema. If you deploy the software locally you can adjust the form by updating the json schema.
