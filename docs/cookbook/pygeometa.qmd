---
title: A participatory metadata workflow
status: ready
---
...
Use the above template to create a metadata file for a dataset. The file should have the same name as the dataset, but with an extension `.yml` or `.mcf`. Alternatively, [MDME](https://osgeo.github.io/mdme) is an online visual editor for mcf files.
