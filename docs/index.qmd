...
- [4) Data organisation](./data-organisation.qmd) 
- [6) data and info sharing](./data-sharing.qmd) 
- [7) Soil Information User Consideration](./consumer.qmd) 

We've labeled each of the articles as to which step in the workflow they apply.

![Soil information workflow](https://isric.euwest01.umbraco.io//media/llqfsdlo/soil-information-workflow-1-copy.jpg?quality=75&rxy=0.502%2C0.5339638484995801)
...
- [Identification and namespaces](identification.qmd)
- [Data harmonization](etl.qmd)
- [Code lists](codelists.qmd)
